...
CREATE PROCEDURE DeductProductFromWarehouse(
    IN p_productID INT,
    IN p_quantity INT,
    IN p_orderID INT
...
BEGIN
    ...
    warehouse_loop: LOOP
        ...
        IF p_quantity > v_warehouse_quantity THEN
			INSERT INTO OrderProduct (orderID, productID, warehouseID, quantity)
            VALUES (p_orderID, p_productID, v_warehouseId, v_warehouse_quantity);
        ...
        ELSE
			...
			INSERT INTO OrderProduct (orderID, productID, warehouseID, quantity, volume)
            VALUES (p_orderID, p_productID, v_warehouseId, p_quantity, v_volumeReduction);
